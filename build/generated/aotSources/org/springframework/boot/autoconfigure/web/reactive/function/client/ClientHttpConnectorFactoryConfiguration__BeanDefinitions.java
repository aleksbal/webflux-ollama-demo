  ...
  public static class ReactorNetty {
    ...
    private static BeanInstanceSupplier<ReactorClientHttpConnectorFactory> getReactorClientHttpConnectorFactoryInstanceSupplier(
      ...
      return BeanInstanceSupplier.<ReactorClientHttpConnectorFactory>forFactoryMethod(ClientHttpConnectorFactoryConfiguration.ReactorNetty.class, "reactorClientHttpConnectorFactory", ReactorResourceFactory.class, ObjectProvider.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.reactive.function.client.ClientHttpConnectorFactoryConfiguration$ReactorNetty", ClientHttpConnectorFactoryConfiguration.ReactorNetty.class).reactorClientHttpConnectorFactory(args.get(0), args.get(1)));
    }
    ...
    public static BeanDefinition getReactorClientHttpConnectorFactoryBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.web.reactive.function.client.ClientHttpConnectorFactoryConfiguration$ReactorNetty");
