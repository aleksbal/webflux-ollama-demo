  ...
  public static class AnnotationConfig {
    ...
    private static BeanInstanceSupplier<HttpHandler> getHttpHandlerInstanceSupplier() {
      return BeanInstanceSupplier.<HttpHandler>forFactoryMethod(HttpHandlerAutoConfiguration.AnnotationConfig.class, "httpHandler", ObjectProvider.class, ObjectProvider.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.reactive.HttpHandlerAutoConfiguration$AnnotationConfig", HttpHandlerAutoConfiguration.AnnotationConfig.class).httpHandler(args.get(0), args.get(1)));
    }
    ...
    public static BeanDefinition getHttpHandlerBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.web.reactive.HttpHandlerAutoConfiguration$AnnotationConfig");
